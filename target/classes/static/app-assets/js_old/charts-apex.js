$(document).ready(function () {
  ...
  var columnChartOptions = {
    ...
    series: [{
      name: 'Correct Ans',
      data: [40, 45, 35, 60, 66, 78, 73, 88, 94,96]
    }, {
      name: 'Score',
      data: [40, 45, 35, 60, 66, 78, 73, 88, 94,96]
    }, {
      name: 'Incorrect Ans',
      data: [60, 55, 65, 40, 34, 22, 27, 12, 6, 4]
    }],
    legend: {
      offsetY: -10
    },
    xaxis: {
      categories: ['Exam 1', 'Exam 2', 'Exam 3', 'Exam 4', 'Exam 5', 'Exam 6', 'Exam 7', 'Exam 8', 'Exam 9','Exam 10'],
    },
    yaxis: {
      title: {
        text: '%'
  ...
  var mixedChartOptions = {
    ...
    series: [{
      ...
      name: 'Score',
      type: 'line',
      data: [30, 45, 36, 25, 65, 85, 78, 89, 88, 92, 95]
    }],
    fill: {
      opacity: [0.85, 0.25, 1],
      gradient: {
    ...
    labels: ['01/01/2020', '02/01/2020', '03/01/2020', '04/01/2020', '05/01/2020', '06/01/2020', '07/01/2020', '08/01/2020', '09/01/2020', '10/01/2020', '10/05/2020'],
    markers: {
      size: 0
    },
    legend: {
 ...
 // var real_data = ${radialChardData};
 var real_data=[75,25,75];
